                    ...
                    <div class="wrap-form-reg clearfix">
                        <form action="#">
                            <div class="left-form">
                                ...
                                <label class="wrap-txt" for="sys_pass_reg">
                                    <input class="input-txt" id="sys_pass_conf" type="password" placeholder="confirm password please!"/>
                                </label>
                                <label class="wrap-txt" for="sys_pass_reg">
                                    <input class="input-txt" id="mobile_reg" type="password" placeholder="mobile number please!"/>
                                </label>
